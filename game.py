...
def game_loop():
    ...
    while running:
        ...
        for event in pygame.event.get():
            if event.type == pygame.QUIT:
                ...
                if event.key == pygame.K_SPACE and not paused:
                    ...
                    paused = not paused
                elif event.key == pygame.K_m or event.key == pygame.K_MENU:
                    return "menu"
                elif not paused:
        ...
        if paused:
            ...
            # These lines create text on how to return to menu during pause
            sub_font = pygame.font.SysFont('Comic Sans MS', 30)
            menu_text = sub_font.render("'M' for Menu", True, (255, 255, 255))
